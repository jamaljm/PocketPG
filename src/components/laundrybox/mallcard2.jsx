     ...
     <div className="foodCard ">
            ...
            <div className="foodCardBottom">
                <div className="foodCardBottomLeft">
                    ...
                    <img src="https://www.cleancityus.com/media/1085/laundromat_services.jpg" alt="" className="foodimage" />
                </div>
                <div className="foodCardBottomRight">
                    <h3 className='text-base'>Shree Laundry</h3>
                    <div className="foodInfo">
                        ...
                        <div className="foodInfoBottom">
                           ...
                           <div className="foodInfoChild">
                                                                                             <span className="foodInfoKey text-b">₹50   </span>
