        ...
        <div class="py-10 sm:py-16 lg:py-24 2xl:pl-24">
            <div class="grid items-center grid-cols-1 gap-y-8 lg:grid-cols-2 lg:gap-x-8 2xl:gap-x-20">
                <div class="lg:order-2 2xl:-mr-24">
                    <img class="w-full shadow-xl rounded-xl" src="https://www.rts.com/wp-content/uploads/2019/11/23405746_1953349674932539_6655836021756150616_o-1-1024x683.jpg" alt="" />
                </div>

                <div class="lg:order-1">
                    <h2 class="text-base font leading-tight text-black sm:text-2xl lg:text-2xl lg:leading-snug">Clean Waste</h2>
                    ...
                    <ul class="grid grid-cols-1 mt-4 sm:mt-10 sm:grid-cols-2 gap-x-10 xl:gap-x-16 gap-y-4 xl:gap-y-6">
                        <li class="flex items-center">
                            ...
                            <span class="ml-3 font-medium text-black"> Fast Pickup</span>
                        </li>
                        ...
                        <li class="flex items-center">
                            ...
                            <span class="ml-3 font-medium text-black"> Environment-friendly
</span>
                        </li>
                        ...
                        <li class="flex items-center">
                            ...
                            <span class="ml-3 font-medium text-black"> Safe and Sustainable </span>
                        </li>
                        ...
                        <li class="flex items-center">
                            ...
                            <span class="ml-3 font-medium text-black"> Bio-composting </span>
                        </li>
                        ...
                        <li class="flex items-center">
                            ...
                            <span class="ml-3 font-medium text-black">schedulable</span>
                        </li>
                    </ul>
